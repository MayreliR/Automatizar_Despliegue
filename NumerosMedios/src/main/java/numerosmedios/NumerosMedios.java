...
public class NumerosMedios {
    ...
    public static ArrayList<Integer> calcularNumerosMedios(int num1, int num2) {
        //Para poder calcular los números que se encuentran en medio del número 1 y número 2
        ...
        if (num1 != num2 && diferencia != 1 && diferencia != -1) {
            System.out.println("Los número que se encuentran en medio del número " + num1 + " y el número " + num2 + " son:");
            if (num1 > num2) {
